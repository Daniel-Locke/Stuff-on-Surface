...
def game_intro():
    ...
    while intro:
        ...
        message_to_screen("The more apples you eat, the longer you get",
                          black, 10, size="small")
        message_to_screen("If you run into yourself, or the borders , you lose",
                          black, 50, size="small")
...
def gameLoop():
    ...
    while not gameExit:
        ...
        snakeBody.append(lead_x)
        snakeBody.append(lead_y)
        snakelist.append(snakeBody)

        if len(snakelist) > snakeLength:
            del snakelist[0]
        #Last item is snake head
        for eachSegment in snakelist[:-1]:
            if eachSegment == snakeBody:
                gameOver = True
